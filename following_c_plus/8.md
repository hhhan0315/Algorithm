# Part 8 객체지향의 기초
* [8.1 객체지향 프로그래밍과 클래스](#객체지향-프로그래밍과-클래스)
* [8.2 캡슐화, 접근 지정자, 접근 함수](#캡슐화-접근-지정자-접근-함수)
* [8.3 생성자 Constructors](#생성자-constructors)
* [8.4 생성자 멤버 초기화 목록 Initializer List](#생성자-멤버-초기화-목록-initializer-list)
* [8.5 위임 생성자](#위임-생성자)
* [8.6 소멸자 destructor](#소멸자-destructor)
* [8.7 this 포인터와 연쇄 호출](#this-포인터와-연쇄-호출)
* [8.8 클래스 코드와 헤더 파일](#클래스-코드와-헤더-파일)
* [8.9 클래스와 const](#클래스와-const)
* [8.10 정적 멤버 변수](#정적-멤버-변수)
* [8.11 정적 멤버 함수](#정적-멤버-함수)
* [8.12 친구 함수와 클래스 friend](#친구-함수와-클래스-friend)
* [8.13 익명 객체](#익명-객체)
